...
canada_raw <- readOGR(dsn = "data/province", layer = "lcma000b16a_e", encoding = 'latin1')
canada_raw_json <- geojson_json(canada_raw)
canada_raw_sim <- ms_simplify(canada_raw_json)
geojson_write(canada_raw_sim, file = "data/canada_province_sim.geojson")

# Read in simplified data ####
canada_cd <- st_read("data/canada_province_sim.geojson", quiet = TRUE) 
